...
# ============================================
BOT_TOKEN = "8842275295:AAE_zKGIGeWSiS2waVjWU9sCGGb0F_BVvxk"
...
def handle_callbacks(call):
    ...
    # ----- Task Verify -----
        ...
        if choice == "yes":
            ...
            username = db.get(user_id, {}).get("username", "မရှိပါ")
...
if __name__ == "__main__":
    ...
    print("🌐 Web URL: https://beta-no7j.onrender.com")
    print("=" * 50)
